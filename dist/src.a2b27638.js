...
var result = checkout(["003", "002", "003", "003", "004"]);
var appContainer = document.getElementById("app");
var priceElement = "<p>\u50F9\u683C\u3002\u4EE5\u672C\u7BC4\u4F8B\u70BA\u4F8B\uFF0C\u50F9\u683C\u70BA\uFF1A$".concat(result.totalPrice, "</p>");
var emptyLine = "<p>\n</p>";
var tableElement = "\n  <table style=\"text-align: center;\">\n    <thead>\n      <tr>\n        <th>#</th>\n        <th>ID</th>\n        <th>\u539F\u50F9</th>\n        <th>\u6D3B\u52D5\u50F9</th>\n      </tr>\n    </thead>\n    <tbody>\n      <tr>\n        <td colspan=\"4\">\n          ----------------------------------------------------\n        </td>\n      </tr>\n      ".concat(result.cart.map(function (_ref) {
  var index = _ref.index,
    id = _ref.id,
    originalPrice = _ref.originalPrice,
    finalPrice = _ref.finalPrice;
  return "\n            <tr>\n              <td>".concat(index, "</td>\n              <td>").concat(id, "</td>\n              <td>").concat(originalPrice, "</td>\n              <td>").concat(finalPrice, "</td>\n            </tr>\n          ");
}).join(""), "\n    </tbody>\n  </table>\n");
if (appContainer) {
  appContainer.innerHTML = priceElement + emptyLine + tableElement;
}
},{"./database.json":"src/database.json"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
